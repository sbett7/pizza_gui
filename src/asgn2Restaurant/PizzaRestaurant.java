...
public class PizzaRestaurant {
	 ...
	 * @throws PizzaException If there was an issue generating a Pizza object, based off of the exceptions described in the Pizza class.
	 * @throws LogHandlerException If there was an issue processing the log file based off of the exceptions described in the LogHandler class.
     *
	 */
	...
	public Customer getCustomerByIndex(int index) throws CustomerException{
		if(index < 0 || index > getNumCustomerOrders()){
			throw new CustomerException("CustomerException Thrown: The given index is outside the bounds of recorded customers.");
		}
	 ...
	 * @throws PizzaException if the index is invalid.
	 */	
	public Pizza getPizzaByIndex(int index) throws PizzaException{
		if(index < 0 || index > getNumPizzaOrders()){
			throw new PizzaException("PizzaException Thrown: The given index is outside the bounds of recorded pizzas.");
		}
